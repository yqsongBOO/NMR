    ...
    def on_test_epoch_end(self) -> None:
        ...
        for repeat in range(1):
            ...
            while samples_left_to_generate > 0:
                ...
                #                            f'graphs/{self.name}/epoch{self.current_epoch}_b{ident}/similarity.csv')
                # df_l = pd.DataFrame(similarity_data)
                # df_l.to_csv(
                #     result_path,
                #     index=False)
        ...
        # df.to_csv('/public/home/ustc_yangqs/molecular2molecular/src/similarity_results_noRetrieval_CH_15_top1_without_formular_wushai.csv', index=False)
